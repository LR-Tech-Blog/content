...
image: {
    ...
    "alt": "Pixel Mood por Alwore (https://alwore.itch.io/pixel-mood)"
}
---
...
- Parte 1 - Construindo os pilares do paradigma (Abstração e Encapsulamento).
- Parte 2 - Construindo os pilares do paradigma (Polimorfismo e Herança).
- Parte 3 - Relacionamento é coisa séria: Relações entre objetos.
- Parte 4 - A prática leva a perfeição: Fixando os conceitos da POO com mais prática.
- Parte 5 - OO de forma inteligente: Os princípios S.O.L.I.D
- Parte 6 - OO de forma inteligente: Aplicando Padrões de projeto (Design Pattern).
- Parte 7 - A prática leva a perfeição 2: OO de forma inteligente com mais prática.
